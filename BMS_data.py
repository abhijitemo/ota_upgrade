...
def uartWrite(msg):
        uart2.write(msg)
        I_LOG.info("[BMS_UART]", "Sent UART message: {}".format(msg))


def get_bms_data():
    #data_response = uartRead()
    data_response = "AT+,A04051223,3145,3165,3185,3204,3145,3165,3185,3204,3145,3165,3185,3204,3145,3165,45,46,48,49,4846,02104,023,001,000,001,001,001,001,\r\n"
    #utime.sleep(1)
    if data_response:
